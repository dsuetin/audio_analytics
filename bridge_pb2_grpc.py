...
class AudioBridgeServicer:
    """Missing associated documentation comment in .proto file."""

    def StreamMic(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
...
def add_AudioBridgeServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'vad.bridge.v1.AudioBridge', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('vad.bridge.v1.AudioBridge', rpc_method_handlers)
...
class AudioBridge:
    ...
    @staticmethod
    def StreamMic(request_iterator,
            target,
            options=(),
